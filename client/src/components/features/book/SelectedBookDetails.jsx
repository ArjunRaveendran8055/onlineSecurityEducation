      ...
      <div className="pt-6">
        <nav aria-label="Breadcrumb">
          ...
          >
            ...
            <li className="text-sm">
              ...
              >
                Fundementals of Cyber Security
              </a>
            </li>
          </ol>
        </nav>
        ...
        <div className="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
          <div className="aspect-h-4 aspect-w-3 hidden overflow-hidden rounded-lg lg:block">
            <img
              src={bookShopData[1].BookImage}
              alt="Two each of gray, white, and black shirts laying flat."
              className="h-full w-full object-cover object-center"
            />
          </div>
          <div className="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
            {/* {another 2 images section} */}
          </div>
          <div className="aspect-h-5 aspect-w-4 lg:aspect-h-4 lg:aspect-w-3 sm:overflow-hidden sm:rounded-lg">
            {
              // another side image of the book
            }
          </div>
        </div>
        {/* Product info */}
        <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
          <div className="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
            <h1 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">
              Hacking the art of expoloitation
            </h1>
          </div>
          {/* Options */}
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <div className="mt-6">
              ...
              <div className="flex items-center">
                ...
                >
                  {bookShopData[1].reviews} reviews
                </a>
              </div>
            </div>
            <div className="mt-10">
              {/* {buttons to add to cart and buy now} */}
              <div className="btns-container flex flex-col justify-around pt-10 gap-5 ">
                <button className="hover:text-white hover:bg-orange p-2 px-4 rounded-3xl text-orange bg-whitesmoke border-2">
                  Buy Now
                </button>
                <button className="hover:text-white hover:bg-orange p-2 px-4 rounded-3xl text-orange bg-whitesmoke border-2">
                  Add to Cart
